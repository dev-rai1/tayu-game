...
const PLAY_STEPS = [
  ...
  ['Do the activity — not just buttons', 'Different challenges use different controls. You may type a number, select an answer, move sliders to build a portfolio, sort items into categories, or make another hands-on choice.'],
  ...
  ['Module 6 · Bond Street', 'Walk to Bond Street and talk to Ben. Work through bond decisions by selecting answers, typing calculations, and adjusting the portfolio sliders.'],
  ['Module 7 · TAYU Tax Office', 'Walk up the Tax Office path and talk to Rex. Complete the practice return using typed math, simple answer selections, and the taxable-versus-excluded sorting activity.'],
