...
export const GRADE_PATHS = [
  ...
  { id: 'high-school', label: 'Grades 9–12', title: 'High School', modules: [1, 2, 3, 4, 5, 6, 7], copy: 'The full 7-module adventure with deeper banking, stock and bond investing, and a practice tax return.' },
]
