export const MODULE_CHECKS = {
  ...
  tax: {
    ...
    cosmetic: { icon: '🧾', name: 'Tax Filing Patch' },
    questions: [
      {
        prompt: 'On the practice W-2, which numbers do you use first to begin the return?',
        choices: ['Wages and federal income tax withheld', 'Only take-home pay', 'Only the name of the employer'],
        answer: 0,
        trick: 'The practice filing flow starts by reading wages and federal income tax withheld from the W-2.',
      },
      {
        prompt: 'In the Tax Filing Lab, how do you find taxable income?',
        choices: ['Add withholding to wages', 'Subtract the practice deduction from wages', 'Multiply withholding by the tax rate'],
        answer: 1,
        trick: 'The simplified activity subtracts the practice deduction from wages before applying the tax brackets.',
      },
      {
        prompt: 'What does a tax credit do in the practice return?',
        choices: ['It increases wages', 'It reduces the tax you calculated', 'It always becomes the full refund'],
        answer: 1,
        trick: 'A tax credit reduces tax directly. It is applied after the bracket calculation in this practice return.',
      },
      {
        prompt: 'If tax withheld is greater than final tax, what happens in the practice return?',
        choices: ['The difference is a refund', 'The difference becomes extra taxable income', 'You automatically owe the difference'],
        answer: 0,
        trick: 'The return reconciles withholding with final tax. More withheld than final tax means a refund of the difference; less withheld can mean an amount due.',
      },
    ],
  },
  garden: {
