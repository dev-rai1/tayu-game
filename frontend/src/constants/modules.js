export const MODULE_CATALOG = [
  ...
  },
  {
    ...
    grades: 'Grades 6–12',
    minutes: '6–8 min',
    desc: 'Carry Money Garden value forward, compare Treasury, municipal, and corporate bonds, allocate the full stake, collect practice interest, and learn bond seniority plus interest-rate risk.',
    color: '#6FA44A',
    worldModule: 6,
  },
  {
    ...
    grades: 'Grades 6–12',
    minutes: '10–15 min',
    desc: 'Work with Rex through gross income, deductions, marginal tax brackets, effective rate, withholding, and a refund, amount due, or zero result, with the municipal-bond callback when earned.',
    color: '#FF8A3D',
    worldModule: 6,
    finale: true,
  },
...
export const EDUCATOR_GRADE_BANDS = [
  ...
  },
  {
    ...
    copy: 'All seven core modules are available. Money Garden is split into 5A and 5B, followed by Module 6 Bond Street and Module 7 TAYU Tax Office.',
  ...
  },
  {
    ...
    copy: 'All seven core modules establish a shared baseline. Module 5A and 5B deepen investing, Module 6 adds fixed income, and Module 7 completes the journey with taxes.',
    currentModules: MODULE_CATALOG,
