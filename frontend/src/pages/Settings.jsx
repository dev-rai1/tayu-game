  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col gap-6 px-5 py-8">
      ...
      <section className="rounded-3xl bg-white/5 p-5">
        ...
        <p className="mt-2 font-semibold text-white/70">
          TAYU always uses the full walkable 3D town. Use the speaker button for music and the Read aloud button on lesson cards. The question-mark menu inside the world replays the controls and learning resources.
        </p>
      </section>
    </main>
  )
