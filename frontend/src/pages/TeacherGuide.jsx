...
import { CURRICULUM_COVERAGE, EDUCATOR_GRADE_BANDS, EXPANSION_MODULES, MODULE_CATALOG } from '../constants/modules.js'
...
const GUIDE = {
  ...
  6: {
    goals: ['Compare Treasury, municipal, and corporate bonds', 'Explain principal, interest, maturity, and credit risk', 'Connect time horizon and risk to a bond choice'],
    decisions: ['Compare issuers and promised payments', 'Calculate a simplified return', 'Adjust a stock-and-bond mix'],
    discuss: ['Why might two bonds offer different interest?', 'How can rising rates affect an existing bond?'],
    evidence: 'Listen for students connecting issuer strength, maturity, and promised return to risk.',
    stop: 'Pause after the issuer comparison or complete the portfolio decision.',
    extension: 'Compare interest-rate risk, default risk, inflation risk, and diversification limits.',
  },
  7: {
