...
export function splitNudge(split, total) {
  ...
  if (split.bond === 0) return 'Bonds are the middle ground — steadier than stocks and designed to pay interest. Worth comparing with the other choices.'
...
export const HANDOFF = (bank, bond, garden) =>
  `Your revised plan kept emergency cash ready, placed $${bank} in the Bank, reserved $${bond} for Bonds, and placed $${garden} in the Money Garden.`
