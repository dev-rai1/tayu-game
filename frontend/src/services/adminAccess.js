...
const DASHBOARD_PASSWORD_HASH = '852f047d4e3e75b27855272a8c375d2641b2e4c51571d2148895a5c1e11cfc2f'
...
export async function openDashboardWithPassword(password) {
  ...
  try {
    ...
    try {
      ...
      if (createError?.code === 'auth/email-already-in-use') throw new Error('Dashboard access could not be verified. Refresh and try again.')
