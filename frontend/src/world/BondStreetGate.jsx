...
export function BondStreetGate({ onComplete }) {
  ...
  // Module 6 is selectable on its own. If a learner enters directly before
  // Money Garden has produced a carried balance, give them a clearly-labeled
  // practice stake instead of trapping them on a disabled Continue button.
  ...
  const runOutcomes = () => {
    ...
    // Never strand a learner over a few unallocated cents. Preserve every
    // choice they made and place only the leftover amount in Treasury.
    if (remaining > 0.009) {
