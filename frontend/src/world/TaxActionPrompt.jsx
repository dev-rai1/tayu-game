...
function shortLabel(phase, nearbyAction) {
  ...
  if (phase === 'intro') return 'Talk to Maya · start Module 6'
  if (phase === 'complete') return 'Talk to Maya · review what you learned'
  return 'Interact'
}
  ...
  return (
    ...
    >
      <button
        ...
        aria-label={`Press E or click here to ${label}`}
      >
        ...
        <span className="min-w-0 text-left leading-tight">
          <span className="block text-xs font-black uppercase tracking-[0.14em] text-white/75">Press E or click here</span>
